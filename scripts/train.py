...
class FatSegmentModel(pytorch_lightning.LightningModule):
    ...
    def __init__(self, arch_name='UNETR',batch_size=1, lr=1e-3, patch_size=(96, 96, 96)):
        super().__init__()
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log_dict({k:v for k,v in d.items() if not isinstance(v, str)}, on_step=True, prog_bar=True)
